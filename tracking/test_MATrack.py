...
from tracker.matrack import MATrack
...
def parse_args():
    parser = argparse.ArgumentParser(description='Test MATrack')
    parser.add_argument('--arch', dest='arch', default='MATrack', help='backbone architecture')
    parser.add_argument('--resume', default="snapshot/MATrack_VOT.pth", type=str, help='pretrained model')
...
def main():
    ...
    siam_tracker = MATrack(siam_info)
